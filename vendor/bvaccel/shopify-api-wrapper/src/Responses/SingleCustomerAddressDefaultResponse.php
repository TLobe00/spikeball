...
use BVAccel\ShopifyApiWrapper\Converters\Request\CustomerAddressRequestConverter;
...
class SingleCustomerAddressDefaultResponse extends SingleResourceResponse
{
    /**
    ...
    {
        return $this->body()->customer_address ?? null;
    }
}